#!/usr/bin/env python3
# Adapted from lit https://github.com/egordorichev/lit/blob/master/benchmark.py
...
LANGUAGES = [
    ("wally",          ["./build/release/Wally", ""],    ".wally"),
    ("python",         ["python2.7"],                    ".py"),
    ("lua",            ["lua"],                          ".lua"),
...
def run_benchmark_language(benchmark, language, benchmark_result):
    ...
    #    else:
        ...
        # Hack: assumes wally gets to run first
        wally_score = benchmark_result["wally"]["score"]
        ratio = 100.0 * wally_score / score
